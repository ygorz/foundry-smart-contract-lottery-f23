...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    error Raffle__TransferOfWinningBalanceFailed();
    ...
    function enterRaffle() external payable {
        /* Not very gas efficient because of storing a string */
        // require(msg.value >= i_entranceFee, "Not enough ETH sent.");
        /* Better but requires a higher solidity version and more compilation steps */
     ...
     * 1. The time has passed between raffle runs
    ...
    // This function needs to get a random number
    ...
    function fulfillRandomWords(
        ...
        if (!success) {
            revert Raffle__TransferOfWinningBalanceFailed();
        }
    }
